...
/**
 * Factory object responsible for creating {@link Transformer} operators. A transformer operator will be
 * requested for each input dataset of workflow tasks; therefore, factory might implement singleton
 * transformer object or create a new object each time when requested depending on the implementation,
 * e.g. thread safety.
 */
@DeveloperApi
public interface TransformerSupport {
    ...
    /**
     * Returns a transformer operator with specific plugin context and operator context that is created
