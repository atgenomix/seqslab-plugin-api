 ...
 * 5 input columns, i.e. the selected column name array from {@link Formatter#select() Select}
 * must have 5 elements.
 */
@DeveloperApi
public interface SupportsUDF5<T1, T2, T3, T4, T5, R> extends Formatter, UDF5<T1, T2, T3, T4, T5, R> {
}
