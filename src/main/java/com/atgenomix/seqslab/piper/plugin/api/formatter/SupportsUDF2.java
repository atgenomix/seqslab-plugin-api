 ...
 * 2 input columns, i.e. the selected column name array from {@link Formatter#select() Select}
 * must have 2 elements.
 */
@DeveloperApi
public interface SupportsUDF2<T1, T2, R> extends Formatter, UDF2<T1, T2, R> {
}
