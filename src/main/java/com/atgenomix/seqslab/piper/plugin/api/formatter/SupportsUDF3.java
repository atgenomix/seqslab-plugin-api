 ...
 * 3 input columns, i.e. the selected column name array from {@link Formatter#select() Select}
 * must have 3 elements.
 */
@DeveloperApi
public interface SupportsUDF3<T1, T2, T3, R> extends Formatter, UDF3<T1, T2, T3, R> {
}
